 ...
 * Uses @DataJpaTest which auto-configures an embedded H2 database (H2 is on testRuntime classpath).
 * [SqliteNetworkRepository] is instantiated manually in each test — no Spring wiring needed
 * for it since the only collaborator requiring injection is the JPA repo.
 *
