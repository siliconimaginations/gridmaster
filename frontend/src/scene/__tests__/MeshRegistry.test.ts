...
const makeGen = (id: string): GeneratorDto => ({
  id, busId: 'b1', name: id, activePowerMw: 100, setpointMw: 100, maxActivePowerMw: 200,
  committed: true, fuelType: 'GAS', marginalCostPerMwh: 48.6, dispatchable: true,
})
