...
const makeDto = (overrides: Partial<GridNetworkDto> = {}): GridNetworkDto => ({
  ...
  generators: [
    { id: 'G1', busId: 'B1', name: 'Gen1', activePowerMw: 80, setpointMw: 80, maxActivePowerMw: 120, committed: true,  fuelType: 'COAL', marginalCostPerMwh: 90.0, dispatchable: true },
    { id: 'G2', busId: 'B1', name: 'Gen2', activePowerMw: 20, setpointMw: 20, maxActivePowerMw:  80, committed: false, fuelType: 'GAS',  marginalCostPerMwh: 48.6, dispatchable: true },
  ],
  loads: [
...
describe('networkDtoToGridGraph', () => {
  ...
  it('computes edge loadFactor from loadingPercent', () => {
    ...
    expect(br1.isNearLimit).toBe(true)   // exactly 70% is >= 70% (#399: non-strict threshold)
